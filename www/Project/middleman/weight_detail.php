...
<body class="seo_version">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right menu-top">
                        ...
                        <li><a class="active" href="weight_detail.php">น้ำหนักยางรอบนี้</a></li>
    ...
    <div class="all-page-title" style="background-image:url(images/pattern-4.png);">
        <div class="container text-center">
            <h1 style="font-family: 'Sarabun', sans-serif; color:rgb(12, 12, 11)">ข้อมูลน้ำหนักยางพารารอบนี้</h1>
            <H1 style="font-family: 'Sarabun', sans-serif; color:rgb(255, 0, 0)"><?php echo $row['total'] ?> กิโลกรัม
            </H1>
    ...
    <div id="support" class="section db">
        <div class="container">
            <div class="section-title text-center">
                <h1 style="font-family: 'Sarabun', sans-serif; color:rgb(255, 255, 255)">ร้านขายอุปกรณ์ยางพารา</h1>
