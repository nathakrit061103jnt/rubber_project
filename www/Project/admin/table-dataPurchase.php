...
$stmt = $conn->prepare("select * from purchase,employee,farmer where purchase.FM_id = farmer.FM_id and purchase.EM_id = employee.EM_id");
$stmt->execute();
$result = $stmt->get_result();
if (isset($_GET['id'])) {
    $userid = $_GET['id'];
    $stmt = $conn->prepare("DELETE FROM purchase WHERE PurchaseID=?");
    $stmt->bind_param("d", $userid);
    $stmt->execute();
    header("Location:table-dataPurchase.php");
}
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="./form-income.php">บันทึกรายรับรายจ่ายลานประมูล</a></li>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ตารางการรับซื้อยางพารา</h4>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    $datespilt = explode("-", $row['PurchaseDate']);
                                                    if ($datespilt[1] == "01") {
                                                        $datespilt[1] = "มกราคม";
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="table-dataPR.php?id=<?php echo $row['PurchaseID'] ?>"
                                                        type="button"
                                                        onclick="return confirm('ต้องการลบข้อมูลใช่หรือไม่ ?')"
                                                        class="btn btn-danger">ลบ</a>
                                                    <a href="report/reportPurchase.php?id=<?php echo $row['PurchaseID'] ?>"
