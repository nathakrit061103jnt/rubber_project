    ...
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h1>บันทึกราคายางพารา</h1>
                                <div class="form-validation">
                                    <form class="form-valide" action="#" method="post">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-date">วันที่ <span
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-email">ราคายาง/หน่วย <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
        ...
        ***********************************-->
        ...
        if (isset($_POST['add'])) {
            ...
            $sqlUp = "INSERT INTO `price_rubber` (`price`, `date`, `PR_id`) 
            VALUES ('{$_POST["price"]}', ' {$_POST["date"]}', NULL);";
            if (mysqli_query($conn, $sqlUp)) {
                ...
                "<script> 
                    Swal.fire({
                        ...
                        timer: 1500
                    }).then(()=> windows.location = 'form-pricerubber.php')
                </script>";
            } else {
                echo
                "<script> 
