...
session_start();
$stmt = $conn->prepare("select * from inform where FM_id = ? ");
...
<!-- Site Metas -->
<title>ข้อมูลลานประมูลยางพารา</title>
...
<body class="seo_version">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right menu-top">
                        <li><a href="Home-user.php">หน้าแรก</a></li>
                        <li><a href="bookings/index.php">แจ้งน้ำหนัก</a></li>
                        <li><a class="active" href="inform.php">ข้อมูลการแจ้งน้ำหนัก</a></li>
    ...
    <div class="all-page-title" style="background-image:url(images/pattern-4.png);">
        <div class="container text-center">
            <h1 style="font-family: 'Sarabun', sans-serif; color:rgb(12, 12, 11)">ข้อมูลการแจ้งน้ำหนัก</h1>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><button type="button" class="btn btn-primary" data-toggle="modal"
                        ...
                        <a href=" inform.php?id=<?php echo $row['InformID'] ?>" type="button"
                            onclick="return confirm('ต้องการลบข้อมูลใช่หรือไม่ ?')" class="btn btn-danger">ลบ</a>
                        <a href="../admin/report/reportInform.php?id=<?php echo $row['InformID'] ?>" type="button"
                            class="btn btn-success" target="_blank">พิมพ์</a>
                    </td>
                </tr>
                <div class="modal fade" id="exampleModal<?php echo $row['InformID'] ?>" tabindex="-1" role="dialog"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <form method="post">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel">แก้ไขข้อมูล
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <input type="hidden" name="InformID" value="<?php echo $row['InformID'] ?>"
                                            class="form-control" id="recipient-name">
                                    </div>
                                    <div class="form-group">
                                        <label for="message-text" class="col-form-label">น้ำหนักโดยประมาณ</label>
                                        <input value="<?php echo $row['weightItem'] ?>" type="text" class="form-control"
                                            id="message-text" name="weightItem">
                                    </div>
                                    <div class="form-group">
                                        <label for="message-text" class="col-form-label">จำนวนกระสอบ</label>
                                        <input value="<?php echo $row['Num_item'] ?>" type="text" class="form-control"
                                            id="message-text" name="Num_item">
                                    </div>
                                    <div class="form-group">
                                        <label for="message-text" class="col-form-label">วันที่</label>
                                        <input value="<?php echo $row['date'] ?>" type="date" class="form-control"
                                            id="message-text" name="date">
                                    </div>
                                    <div class="form-group">
                                        <input value="<?php echo $row['FM_id'] ?>" type="hidden" class="form-control"
                                            id="message-text" name="FM_id">
                                    </div>
                                    <div class="form-group">
                                        <input value="<?php echo $row['weightnum'] ?>" type="text" class="form-control"
