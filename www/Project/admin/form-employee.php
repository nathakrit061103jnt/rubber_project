    ...
    <div id="main-wrapper">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="./form-employee.php" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">เลือกตำแหน่ง <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <select class="form-control" name="Position">
                                                    ...
                                                    <option>ประธานเจ้าหน้าที่</option>
                                                    <option>รองประธานเจ้าหน้าที่</option>
                                                    <option>เจ้าหน้าที่ลานประมูล</option>
                                                    <option>เจ้าหน้าที่การตลาด</option>
                                                    <option>เจ้าหน้าที่บัญชี</option>
                                                    <option>เจ้าหน้าที่ชั่งน้ำหนัก</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">ชื่อผู้ใช้<span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">รหัสผ่าน<span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
        ...
        ***********************************-->
        ...
        if (isset($_POST['add'])) {
            ...
            $sqlUp = "INSERT INTO `employee` (`EM_id`, `EM_name`, `Address`, `tel`, `email`, `ID_code`, `Position`, `username`, `password`) 
            VALUES (NULL, '{$_POST["EM_name"]}', '{$_POST["Address"]}', '{$_POST["tel"]}', '{$_POST["email"]}', '{$_POST["ID_code"]}',
            '{$_POST["Position"]}', '{$_POST["username"]}', '{$_POST["password"]}');";
            if (mysqli_query($conn, $sqlUp)) {
                ...
                "<script> 
                    Swal.fire({
                        ...
                        timer: 1500
                    }).then(()=> windows.location = './form-employee.php')
                </script>";
            } else {
                echo
                "<script> 
