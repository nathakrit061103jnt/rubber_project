...
$date = $_GET['date'];
$stmt = $conn->prepare("select * from pricemiddleman where date = ?");
                ...
                <div class="card">
                    <div class="card-header p-4">
                        <div class="float-right">
                            <h3 class="mb-0">ใบแจ้งราคายางพารา</h3>
                            ...
                            <div class="col-lg-4 col-sm-5 ml-auto">
                                <table class="table table-clear">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="left">
                                                <strong class="text-dark">ลงชื่อผู้ออกรายงาน</strong>
                                            </td>
                                            <td class="right"></td>
                                        </tr>
                                        <tr>
