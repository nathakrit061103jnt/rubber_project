    ...
    <div id="main-wrapper">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="./form-farmer.php" method="post">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">ชื่อ - นามสกุล<span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="FM_name" name="FM_name">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">จำนวนสวนยางพารา(ไร่)<span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="Total_rubber"
                                                    name="Total_rubber">
                                            </div>
                                        </div>
                                        <div class="form-group row">
        ...
        ***********************************-->
        ...
        if (isset($_POST['add'])) {
            ...
            $sqlUp = "INSERT INTO `farmer` (`FM_id`, `FM_name`, `ID_code`, `address`, `tel`, `email`, `Total_rubber`, `username`, `password`) 
            VALUES (NULL, '{$_POST["FM_name"]}', '{$_POST["ID_code"]}', '{$_POST["address"]}', '{$_POST["tel"]}', '{$_POST["email"]}',
            '{$_POST["Total_rubber"]}', '{$_POST["username"]}', '{$_POST["password"]}');";
            if (mysqli_query($conn, $sqlUp)) {
                ...
                "<script> 
                    Swal.fire({
                        ...
                        timer: 1500
                    }).then(()=> windows.location = 'form-farmer.php')
                </script>";
            } else {
                echo
                "<script> 
