...
$stmt1 = $conn->prepare("select * from employee");
$stmt1->execute();
    ...
    <div id="main-wrapper">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="form-validation">
                                    <form class="form-valide" action="form-sale.php" method="post">
                                        <h1>การขายยางพารา</h1>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">ชื่อพ่อค้า <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <select class="form-control" name="cus">
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $row["MD_id"] ?>">
                                                        <?php echo $row["MD_name"] ?></option>
                                                    <?php
                                                        }
                                                    }
                                                    ?>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="weightItem"
                                                    name="weightItem" placeholder="100 กิโลกรัม">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="val-date">พนักงานที่บันทึก <span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
        ...
        ***********************************-->
        ...
        if (isset($_POST['add'])) {
            ...
            $Balance = (intval($_POST['weightItem']) * 0.5);
            $sqlUp = "INSERT INTO sale (saleID, SaleDate, weightItem, TotalPrice, MD_id, EM_id, price) 
    VALUES (NULL, '{$_POST["SaleDate"]}', '{$_POST["weightItem"]}', '{$TotalPrice}', '{$_POST["cus"]}', '{$_POST["emp"]}', '{$_POST["price"]}');";
            $sqlin = "INSERT INTO income (IncomeID, date_income, Balance, EM_id) 
    VALUES (NULL, '{$_POST["SaleDate"]}', '{$Balance}' , '{$_POST["emp"]}');";
            if (mysqli_query($conn, $sqlUp) && mysqli_query($conn, $sqlin)) {
                echo
                "<script> 
                    Swal.fire({
                        position: 'center',
                        ...
                        timer: 1500
                    }).then(()=> windows.location = 'form-sale.php')
                </script>";
            } else {
                echo
                "<script> 
