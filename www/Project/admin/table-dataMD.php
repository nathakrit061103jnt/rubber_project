...
$stmt = $conn->prepare("select * from middleman");
$stmt->execute();
$result = $stmt->get_result();
if (isset($_GET['id'])) {
    $userid = $_GET['id'];
    $stmt = $conn->prepare("DELETE FROM middleman WHERE MD_id=?");
    $stmt->bind_param("d", $userid);
    $stmt->execute();
    header("Location:table-dataMD.php");
}
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ข้อมูลพ่อค้า</h4>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['MD_id'] ?></td>
                                                        <td><?php echo $row['MD_name'] ?></td>
                                                        <td><?php echo $row['MD_address'] ?></td>
                                                        <td><?php echo $row['tel'] ?></td>
                                                        <td><?php echo $row['email'] ?></td>
                                                        <td><?php echo $row['ID_code'] ?></td>
                                                        <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal<?php echo $row['MD_id'] ?>">แก้ไข</button>
                                                            <a href="table-dataMD.php?id=<?php echo $row['MD_id'] ?>" type="button" onclick="return confirm('ต้องการลบข้อมูลใช่หรือไม่ ?')" class="btn btn-danger">ลบ</a>
                                                        </td>
                                                    </tr>
                                                    <div class="modal fade" id="exampleModal<?php echo $row['MD_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <form method="post">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            <input type="hidden" name="MD_id" value="<?php echo $row['MD_id'] ?>" class="form-control" id="recipient-name">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="col-form-label">ชื่อ - นามสกุล</label>
                                                                            <input value="<?php echo $row['MD_name'] ?>" type="text" class="form-control" id="message-text" name="MD_name">
                                                                        </div>
                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input value="<?php echo $row['MD_address'] ?>" type="text" class="form-control" id="message-text" name="MD_address">
                                                                        </div>
                                                                        <div class="form-group">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input value="<?php echo $row['email'] ?>" type="text" class="form-control" id="message-text" name="email">
                                                                        </div>
                                                                    </div>
        ...
        ***********************************-->
        ...
        if (isset($_POST["SubmitUpdate"])) {
            ...
            $sqlUp = "UPDATE middleman md SET md.MD_name = '{$_POST["MD_name"]}', md.MD_address = '{$_POST["MD_address"]}' , md.tel = '{$_POST["tel"]}',
             md.email = '{$_POST["email"]}', md.ID_code = '{$_POST["ID_code"]}'
                      WHERE md.MD_id = '{$_POST["MD_id"]}';";
            ...
            if (mysqli_query($conn, $sqlUp)) {
                ...
                "<script> 
                    Swal.fire({
                        ...
                        timer: 1500
                    }).then(()=> location = 'table-dataMD.php')
                </script>";
            } else {
                echo
                "<script> 
