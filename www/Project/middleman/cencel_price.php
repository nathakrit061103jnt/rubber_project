...
$stmt = $conn->prepare("select * from pricemiddleman where MD_id = ?");
...
if (isset($_GET['id'])) {
    ...
    $stmt->execute();
    header("Location:cencel_price.php");
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="seo_version">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav navbar-right menu-top">
                        ...
                        <li><a class="active" href="cencel_price.php">ข้อมูลการยื่นราคา</a></li>
    ...
    <div class="all-page-title" style="background-image:url(images/pattern-4.png);">
        <div class="container text-center">
            <h1 style="font-family: 'Sarabun', sans-serif; color:rgb(12, 12, 11)">ข้อมูลการยื่นราคา</h1>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><button type="button" class="btn btn-primary" data-toggle="modal"
                        ...
                        <a href="cencel_price.php?id=<?php echo $row['PRMD_id'] ?>" type="button"
                            onclick="return confirm('ต้องการลบข้อมูลใช่หรือไม่ ?')" class="btn btn-danger">ลบ</a>
                    </td>
                </tr>
                <div class="modal fade" id="exampleModal<?php echo $row['PRMD_id'] ?>" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        <input type="hidden" name="PRMD_id" value="<?php echo $row['PRMD_id'] ?>"
                                            class="form-control" id="recipient-name">
                                    </div>
                                    <div class="form-group">
                                        <label for="message-text" class="col-form-label">ชื่อ - นามสกุล</label>
                                        <input value="<?php echo $row['PRMD_name'] ?>" type="text" class="form-control"
                                            id="message-text" name="PRMD_name">
                                    </div>
                                    <div class="form-group">
                                        <label for="message-text" class="col-form-label">ราคาที่ยื่น</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="<?php echo $row['tel'] ?>" type="text" class="form-control"
                                            id="message-text" name="tel">
                                    </div>
                                    <div class="form-group">
                                        <input value="<?php echo $row['MD_id'] ?>" type="hidden" class="form-control"
    ...
    if (isset($_POST["SubmitUpdate"])) {
        ...
        $sqlUp = "UPDATE pricemiddleman pm SET pm.PRMD_name = '{$_POST["PRMD_name"]}', pm.Price = '{$_POST["Price"]}' 
                , pm.tel = '{$_POST["tel"]}', pm.MD_id = '{$_POST["MD_id"]}' WHERE pm.PRMD_id = '{$_POST["PRMD_id"]}';";
        ...
        if (mysqli_query($conn, $sqlUp)) {
            ...
            "<script> 
                    Swal.fire({
                        ...
                        timer: 1500
                    }).then(()=> location = 'cencel_price.php')
                </script>";
        } else {
            echo
            "<script> 
