...
if (isset($_GET['id'])) {
    ...
    $stmt->execute();
    header("Location:table-dataEM.php");
}
    ...
    <div id="main-wrapper">
            ...
            <div class="brand-logo">
                <a href="index.php">
                    ...
                    <span class="brand-title">
                        <img src="images/lanlogo.png" style="position: absolute;top: 4%;" width="190" height="80" alt="">
                    </span>
                </a>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">ข้อมูลพนักงานลานประมูล</h4>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal<?php echo $row['EM_id'] ?>">แก้ไข</button>
                                                            <a href="table-dataEM.php?id=<?php echo $row['EM_id'] ?>" type="button" onclick="return confirm('ต้องการลบข้อมูลใช่หรือไม่ ?')" class="btn btn-danger">ลบ</a>
                                                        </td>
                                                    </tr>
                                                    <div class="modal fade" id="exampleModal<?php echo $row['EM_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                        <form method="post">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="form-group">
                                                                            <input type="hidden" name="EM_id" value="<?php echo $row['EM_id'] ?>" class="form-control" id="recipient-name">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="col-form-label">ชื่อ - นามสกุล</label>
                                                                            <input value="<?php echo $row['EM_name'] ?>" type="text" class="form-control" id="message-text" name="EM_name">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="col-form-label">รหัสประจำตัวประชาชน</label>
                                                                            <input value="<?php echo $row['ID_code'] ?>" type="text" class="form-control" id="message-text" name="ID_code">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="col-form-label">ที่อยู่</label>
                                                                            <input value="<?php echo $row['Address'] ?>" type="text" class="form-control" id="message-text" name="Address">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="col-form-label">เบอร์โทร</label>
                                                                            <input value="<?php echo $row['tel'] ?>" type="text" class="form-control" id="message-text" name="tel">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="col-form-label">อีเมลล์</label>
                                                                            <input value="<?php echo $row['email'] ?>" type="test" class="form-control" id="message-text" name="email">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="col-form-label">ตำแหน่ง</label>
                                                                            <input value="<?php echo $row['Position'] ?>" type="text" class="form-control" id="message-text" name="Position">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="col-form-label">ชื่อผู้ใช้</label>
                                                                            <input value="<?php echo $row['username'] ?>" type="text" class="form-control" id="message-text" name="username">
                                                                        </div>
                                                                        <div class="form-group">
                                                                            <label for="message-text" class="col-form-label">รหัสผ่าน</label>
                                                                            <input value="<?php echo $row['password'] ?>" type="text" class="form-control" id="message-text" name="password">
                                                                        </div>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">ปิด</button>
                                                                        <button type="submit" name="SubmitUpdate" class="btn btn-primary">เเก้ไข
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </div>
        ...
        ***********************************-->
        ...
        if (isset($_POST["SubmitUpdate"])) {
            ...
            $sqlUp = "UPDATE employee em SET em.EM_name = '{$_POST["EM_name"]}', em.Address = '{$_POST["Address"]}' , em.tel = '{$_POST["tel"]}',
             em.email = '{$_POST["email"]}', em.ID_code = '{$_POST["ID_code"]}', em.Position = '{$_POST["Position"]}', em.username = '{$_POST["username"]}', em.password = '{$_POST["password"]}'
                      WHERE em.EM_id = '{$_POST["EM_id"]}';";
            ...
            if (mysqli_query($conn, $sqlUp)) {
                ...
                "<script> 
                    Swal.fire({
                        ...
                        timer: 1500
                    }).then(()=> location = 'table-dataEM.php')
                </script>";
            } else {
                echo
                "<script> 
