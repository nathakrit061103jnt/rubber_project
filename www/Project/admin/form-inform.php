    ...
    <div id="main-wrapper">
            ...
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h1>แจ้งน้ำหนักยางพารา</h1>
                                <div class="form-validation">
                                    <form class="form-valide" action="form-inform.php" method="post">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">จำนวนกระสอบ<span
                                                    class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="Num_item" name="Num_item">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label"">รหัสรอบการแจ้ง
                                                <span class=" text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="weightnum" name="weightnum">
                                            </div>
                                        </div>
                                        <div class="form-group row">
        ...
        ***********************************-->
        ...
        if (isset($_POST['add'])) {
            ...
            $sqlUp = "INSERT INTO `inform` (`InformID`, `weightItem`, `Num_item`, `date`, `FM_id`, `weightnum`) 
            VALUES (NULL, '{$_POST["weightItem"]}', '{$_POST["Num_item"]}', '{$_POST["date"]}', '{$_POST["cus"]}', '{$_POST["weightnum"]}');";
            if (mysqli_query($conn, $sqlUp)) {
                ...
                "<script> 
                    Swal.fire({
                        ...
                        timer: 1500
                    }).then(()=> windows.location = 'form-inform.php')
                </script>";
            } else {
                echo
                "<script> 
