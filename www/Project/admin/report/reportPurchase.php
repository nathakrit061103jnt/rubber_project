...
$id = $_GET['id'];
$stmt = $conn->prepare("select * from purchase where PurchaseID = ?");
$stmt->bind_param("s", $id);
$stmt->execute();
$result1 = $stmt->get_result();
$row1 = mysqli_fetch_assoc($result1);

$stmt = $conn->prepare("select * from farmer where farmer.FM_id = ?");
$stmt->bind_param("d", $row1['FM_id']);
$stmt->execute();
$result3 = $stmt->get_result();
$row3 = mysqli_fetch_assoc($result3);

$stmt = $conn->prepare("select * from farmer,inform where farmer.FM_id = inform.FM_id and inform.InformID = ?");
$stmt->bind_param("d", $row1['InformID']);
$stmt->execute();
$result2 = $stmt->get_result();
$datespilt = explode("-", $row1['PurchaseDate']);
if ($datespilt[1] == "01") {
    $datespilt[1] = "มกราคม";
...
<head>
    ...
    <title>ใบแจ้งการรับซื้อยางพารา</title>
</head>
                ...
                <div class="card">
                    <div class="card-header p-4">
                        <div class="float-right">
                            <h3 class="mb-0">ใบแจ้งการรับซื้อยางพารา</h3>
                    ...
                    <div class="card-body">
                        <div class="row mb-4">
                            <div class="col-sm-6">
                                ...
                                <h5 class="mb-3" class="text-dark mb-1">ถึง : <?php echo $row3['FM_name'] ?>
                                </h5>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="center">น้ำหนักยางพารา(แจ้ง)</th>
                                        <th class="center">น้ำหนักยางพารา(ที่ชั่ง)</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $row2['FM_name'] ?></td>
                                        <td class="right"><?php echo $datethai ?></td>
                                        <td class="center"><?php echo $row2['weightItem'] ?></td>
                                        <td class="center"><?php echo $row1['weightItem'] ?></td>
                                        <td class="center"><?php echo $row1['price'] ?></td>
                                        <td class="center"><?php echo $row1['TotalPrice'] ?></td>
                                    </tr>
                                    <?php
                                            $index++;
                                        }
